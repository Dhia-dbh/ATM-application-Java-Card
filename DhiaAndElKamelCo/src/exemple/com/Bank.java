...
public class Bank extends Applet {
	...
	private Bank(byte[] bArray,int i,int j) {
		...
		// Allocate memory for HashedPIN and initialize it with the PIN's hash 
	...
	private void setBalance(APDU apdu) {
		...
		// Formule de calcul: (a + b + ... + z) * 127 + reste avec a, _ , z les chiffres passés dans le buffer
		// de la case ISO7816.OFFSET_CDATA jusqu'à ISO7816.OFFSET_CDATA + (byteRead - 1) 
		int a_z=0;
